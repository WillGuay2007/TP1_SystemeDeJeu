...
public class PlayerInputController : MonoBehaviour
{
    ...
    public void Init()
    {
        m_healthController.OnDeath += DisableInput;
        m_dialogueController.OnDialogueStarted += DisableInput;
        m_dialogueController.OnDialogueEnded += EnableInput;
    }
    ...
    {
        //print("[INPUT CONTROLLER] -> Disabled input");
